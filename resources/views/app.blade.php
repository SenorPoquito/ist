...
<div class="wrapper">
    ...
    <div class="navigation">
        <div class="secondary-navigation">
            <div class="container">
                <div class="contact">
                    <figure><strong>Phone:</strong>+81-80-2231-2233</figure>
                    <figure><strong>Email:</strong>contact@international-schools-tokyo.com</figure>
                </div>
                <div class="user-area">
                    <div class="actions">
                        Languages
                    ...
                    <div class="language-bar">
                        ...
                        <a href="#"><img src="{{ asset('img/flags/jp.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="#">Schools</a>
